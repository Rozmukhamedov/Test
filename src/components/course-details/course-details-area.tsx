                  ...
                  <div className="cd-information mb-35">
                    <ul>
                      <li>
                        ...
                        <label>Lesson</label> <span>{data?.lesson}</span>
                      </li>
                      <li>
                        <i className="fi fi-rr-chart-pie-alt"></i>{" "}
                        <label>Quizess</label> <span>{data?.quizess}</span>
                      </li>
                      <li>
                        <i className="fi fi-rr-user"></i>{" "}
                        <label>Students</label> <span>{data?.students}</span>
                      </li>
                      <li>
                        <i className="fa-light fa-clock-desk"></i>{" "}
                        <label>Duration</label> <span>{data.duration}</span>
                      </li>
                      <li>
                        <i className="fi fi-sr-stats"></i>{" "}
                        <label>Skill Level</label> <span>{data.level}</span>
                      </li>
                      <li>
                        <i className="fi fi-rr-comments"></i>{" "}
                        <label>Language</label> <span>{data.language}</span>
                      </li>
                      <li>
